...
export class FormAddnewComponent implements OnInit {
  ...
  constructor(public formbuilder: FormBuilder, private formDesignerService: FormDesignerService, private dialog: MatDialog, private fb: FormBuilder, public snackBar: MatSnackBar) {
